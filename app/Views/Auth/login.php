...
<body>  
    <div class="form-group">
        ...
        <?php endif?>
        <form action="<?php echo site_url('auth/login');?>" method="post" class="form-group"> 
                <h1>
                ...
                <label class="text-dark">Votre Nom:*</label>
        ...
        <p>Pas encore Inscrit?<a href="<?=site_url('auth/register');?>">Connecter-vous</a></p>
    </div>
</body>
</html>